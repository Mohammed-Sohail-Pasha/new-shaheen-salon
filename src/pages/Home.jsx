    ...
    <div className="home-page">
        ...
        <div className="container hero-content">
          <div className="hero-text">
            ...
            <div className="hero-cta">
              <a href="tel:+919964785000" className="btn btn-primary">
      ...
      <section className="cta-banner section">
        <div className="container text-center cta-inner">
          ...
          <a href="tel:+919964785000" className="btn btn-primary cta-btn">
        ...
        <div className="container">
          ...
          <div className="grid grid-2">
            <div className="location-details">
              ...
              <a href="tel:+919964785000" className="btn btn-dark mt-20">Call For Directions</a>
            </div>
